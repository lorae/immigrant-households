...
# (including themselves). By 2023, this had fallen to x people, a decline of x%.
...
hhsize2023 <- hhsize_decade |> filter(decade == 2023) |> pull(weighted_mean)

((hhsize1970 - hhsize2023) / hhsize1970)*100
